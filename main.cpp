...
int main()
{
    while(1) {
        ...
        if(pinSW4 == 1){ //eher mit pwm und helligkeit verstellen
        ...
        if(pinSW2 == 1 && pinSW3 == 1) {
            POR(n);

        } else if(pinSW2 == 1 && pinSW1 == 1) {
            fSW2(n);
        ...
        if(pinSW3 == 1 && pinSW2 == 1) {
            POR(n);
        } else if(pinSW3 == 1 && pinSW1 == 1) {
            fSW3(n);
        } else if(pinSW3 == 1 && pinSW1 == 0) {
            bSW3(n);
        }
